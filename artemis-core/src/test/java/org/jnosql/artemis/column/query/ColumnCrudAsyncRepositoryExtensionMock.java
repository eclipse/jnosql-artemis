...
public class ColumnCrudAsyncRepositoryExtensionMock implements Extension {
    ...
    void onAfterBeanDiscovery(@Observes final AfterBeanDiscovery afterBeanDiscovery, final BeanManager beanManager) {
        types.forEach(t -> {
            final CrudRepositoryAsyncColumnBean bean = new CrudRepositoryAsyncColumnBean(t, beanManager, "columnRepositoryMock");
