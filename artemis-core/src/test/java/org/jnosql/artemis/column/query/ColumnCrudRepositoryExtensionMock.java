...
public class ColumnCrudRepositoryExtensionMock implements Extension {
    ...
    void onAfterBeanDiscovery(@Observes final AfterBeanDiscovery afterBeanDiscovery, final BeanManager beanManager) {
        types.forEach(t -> {
            final CrudRepositoryColumnBean bean = new CrudRepositoryColumnBean(t, beanManager, "columnRepositoryMock");
